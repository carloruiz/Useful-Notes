...
export LS_COLORS="di=37;40:ln=35;40:so=32;40:pi=33;40:ex=31;40:bd=34;46:cd=34;43:su=0;41:sg=0;46:tw=0;42:ow=0;43:"
...
PATH="/Library/Frameworks/Python.framework/Versions/2.7/bin:${PATH}:/usr/lib/python2.7/site-packages"
export PATH
...
# The original version is saved in .bash_profile.pysave
PATH="/usr/local/lib/python3.6/site-packages:/Library/Frameworks/Python.framework/Versions/3.6/bin:${PATH}"
export PATH

# setting path for scipy numpy etc
PATH="${PATH}:/Users/carloruiz/Library/Python/3.6/bin"
export PATH
alias ls=ls
